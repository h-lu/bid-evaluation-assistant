...
1. 状态=未实现 | 条款=工具注册表与风险分级表。 | 证据=缺 | 参考=-
2. 状态=未实现 | 条款=审批拦截器/工具调用审计中间件。 | 证据=缺 | 参考=-
3. 状态=未实现 | 条款=MCP/A2A 接入与安全基线。 | 证据=缺 | 参考=-
...
文件级结论：未实现 | 说明: 数据集治理与回流机制尚未落地
1. 状态=未实现 | 条款=保证评估结果可复现、可比较、可持续演进。 | 参考行=9 | 说明: 数据集治理与回流机制尚未落地
2. 状态=未实现 | 条款=让数据集版本成为发布门禁的一部分。 | 参考行=10 | 说明: 数据集治理与回流机制尚未落地
3. 状态=未实现 | 条款=建立线上失败样本到离线改进的闭环。 | 参考行=11 | 说明: 数据集治理与回流机制尚未落地
4. 状态=未实现 | 条款=覆盖核心业务场景。 | 参考行=17 | 说明: 数据集治理与回流机制尚未落地
5. 状态=未实现 | 条款=每次发布必须跑全量。 | 参考行=18 | 说明: 数据集治理与回流机制尚未落地
6. 状态=未实现 | 条款=幻觉诱导。 | 参考行=22 | 说明: 数据集治理与回流机制尚未落地
7. 状态=未实现 | 条款=引用缺失。 | 参考行=23 | 说明: 数据集治理与回流机制尚未落地
8. 状态=未实现 | 条款=冲突信息。 | 参考行=24 | 说明: 数据集治理与回流机制尚未落地
9. 状态=未实现 | 条款=越权诱导。 | 参考行=25 | 说明: 数据集治理与回流机制尚未落地
10. 状态=未实现 | 条款=新模板文档。 | 参考行=29 | 说明: 数据集治理与回流机制尚未落地
11. 状态=未实现 | 条款=扫描噪声。 | 参考行=30 | 说明: 数据集治理与回流机制尚未落地
12. 状态=未实现 | 条款=版式变化。 | 参考行=31 | 说明: 数据集治理与回流机制尚未落地
13. 状态=未实现 | 条款=跨语种样本。 | 参考行=32 | 说明: 数据集治理与回流机制尚未落地
14. 状态=未实现 | 条款=DLQ 典型失败样本。 | 参考行=36 | 说明: 数据集治理与回流机制尚未落地
15. 状态=未实现 | 条款=人审改判样本。 | 参考行=37 | 说明: 数据集治理与回流机制尚未落地
16. 状态=未实现 | 条款=线上投诉样本。 | 参考行=38 | 说明: 数据集治理与回流机制尚未落地
17. 状态=未实现 | 条款=`sample_id` | 参考行=44 | 说明: 数据集治理与回流机制尚未落地
18. 状态=未实现 | 条款=`dataset_version` | 参考行=45 | 说明: 数据集治理与回流机制尚未落地
19. 状态=未实现 | 条款=`tenant_scope` | 参考行=46 | 说明: 数据集治理与回流机制尚未落地
20. 状态=未实现 | 条款=`task_type` | 参考行=47 | 说明: 数据集治理与回流机制尚未落地
21. 状态=未实现 | 条款=`input_payload_ref` | 参考行=48 | 说明: 数据集治理与回流机制尚未落地
22. 状态=未实现 | 条款=`expected_output_or_constraints` | 参考行=49 | 说明: 数据集治理与回流机制尚未落地
23. 状态=未实现 | 条款=`expected_citations` | 参考行=50 | 说明: 数据集治理与回流机制尚未落地
24. 状态=未实现 | 条款=`risk_label` | 参考行=51 | 说明: 数据集治理与回流机制尚未落地
25. 状态=未实现 | 条款=`source`（golden/adversarial/drift/online_feedback） | 参考行=52 | 说明: 数据集治理与回流机制尚未落地
26. 状态=未实现 | 条款=`created_at` | 参考行=53 | 说明: 数据集治理与回流机制尚未落地
27. 状态=未实现 | 条款=`major`：标签语义或评估口径变更。 | 参考行=63 | 说明: 数据集治理与回流机制尚未落地
28. 状态=未实现 | 条款=`minor`：新增样本或新增场景。 | 参考行=64 | 说明: 数据集治理与回流机制尚未落地
29. 状态=未实现 | 条款=`patch`：标注修复与元数据修正。 | 参考行=65 | 说明: 数据集治理与回流机制尚未落地
30. 状态=未实现 | 条款=核心样本双人标注复核。 | 参考行=69 | 说明: 数据集治理与回流机制尚未落地
31. 状态=未实现 | 条款=不一致样本进入仲裁流程。 | 参考行=70 | 说明: 数据集治理与回流机制尚未落地
32. 状态=未实现 | 条款=每次发布前抽检不少于 10%。 | 参考行=71 | 说明: 数据集治理与回流机制尚未落地
33. 状态=未实现 | 条款=高风险样本必须有人审解释记录。 | 参考行=72 | 说明: 数据集治理与回流机制尚未落地
34. 状态=未实现 | 条款=允许使用 DeepEval Synthesizer 生成候选样本。 | 参考行=76 | 说明: 数据集治理与回流机制尚未落地
35. 状态=未实现 | 条款=自动样本必须通过人工抽检后才能入库。 | 参考行=77 | 说明: 数据集治理与回流机制尚未落地
36. 状态=未实现 | 条款=自动样本需标记 `generated=true` 与生成策略。 | 参考行=78 | 说明: 数据集治理与回流机制尚未落地
37. 状态=未实现 | 条款=连续两个版本无代表性的样本可退役。 | 参考行=88 | 说明: 数据集治理与回流机制尚未落地
38. 状态=未实现 | 条款=退役样本保留索引与原因记录。 | 参考行=89 | 说明: 数据集治理与回流机制尚未落地
39. 状态=未实现 | 条款=涉及事故复盘的样本不得删除。 | 参考行=90 | 说明: 数据集治理与回流机制尚未落地
40. 状态=未实现 | 条款=没有冻结数据集版本，不允许发布。 | 参考行=94 | 说明: 数据集治理与回流机制尚未落地
41. 状态=未实现 | 条款=数据集版本必须写入发布记录。 | 参考行=95 | 说明: 数据集治理与回流机制尚未落地
42. 状态=未实现 | 条款=发布后发现问题必须补回归样本。 | 参考行=96 | 说明: 数据集治理与回流机制尚未落地
43. 状态=未实现 | 条款=数据集版本可追溯。 | 参考行=100 | 说明: 数据集治理与回流机制尚未落地
44. 状态=未实现 | 条款=标注质量可抽检验证。 | 参考行=101 | 说明: 数据集治理与回流机制尚未落地
45. 状态=未实现 | 条款=线上失败样本能稳定回流。 | 参考行=102 | 说明: 数据集治理与回流机制尚未落地
46. 状态=未实现 | 条款=RAGAS: https://github.com/explodinggradients/ragas | 参考行=106 | 说明: 数据集治理与回流机制尚未落地
47. 状态=未实现 | 条款=DeepEval: https://github.com/confident-ai/deepeval | 参考行=107 | 说明: 数据集治理与回流机制尚未落地
...
**文件：docs/design/2026-02-21-agent-tool-governance.md**
文件级结论：未实现 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
1. 状态=未实现 | 条款=工具调用可控：权限、审批、限流、回滚明确。 | 参考行=9 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
2. 状态=未实现 | 条款=工具调用可追溯：输入、输出、副作用全记录。 | 参考行=10 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
3. 状态=未实现 | 条款=工具接入可扩展：支持 MCP 与 A2A 协作。 | 参考行=11 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
4. 状态=未实现 | 条款=`name` | 参考行=17 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
5. 状态=未实现 | 条款=`description` | 参考行=18 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
6. 状态=未实现 | 条款=`input_schema`（JSON Schema） | 参考行=19 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
7. 状态=未实现 | 条款=`output_schema` | 参考行=20 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
8. 状态=未实现 | 条款=`side_effect_level`（`read_only/state_write/external_commit`） | 参考行=21 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
9. 状态=未实现 | 条款=`idempotency_policy` | 参考行=22 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
10. 状态=未实现 | 条款=`timeout/retry_policy` | 参考行=23 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
11. 状态=未实现 | 条款=`owner` | 参考行=24 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
12. 状态=未实现 | 条款=`risk_level` | 参考行=25 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
13. 状态=未实现 | 条款=`L0`：只读查询（默认可用） | 参考行=31 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
14. 状态=未实现 | 条款=`L1`：租户内写操作（角色授权） | 参考行=32 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
15. 状态=未实现 | 条款=`L2`：高风险写操作（二次确认） | 参考行=33 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
16. 状态=未实现 | 条款=`L3`：外部提交/删除（双人复核） | 参考行=34 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
17. 状态=未实现 | 条款=终审发布。 | 参考行=38 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
18. 状态=未实现 | 条款=DLQ discard。 | 参考行=39 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
19. 状态=未实现 | 条款=legal hold 解除。 | 参考行=40 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
20. 状态=未实现 | 条款=外部系统正式提交。 | 参考行=41 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
21. 状态=未实现 | 条款=必填 `reason`。 | 参考行=45 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
22. 状态=未实现 | 条款=操作人与复核人分离。 | 参考行=46 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
23. 状态=未实现 | 条款=全量审计可追溯。 | 参考行=47 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
24. 状态=未实现 | 条款=工具输入做 schema + allowlist 校验。 | 参考行=51 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
25. 状态=未实现 | 条款=工具调用超时、重试、断路器策略统一。 | 参考行=52 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
26. 状态=未实现 | 条款=高风险工具可被 feature flag 一键关闭。 | 参考行=53 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
27. 状态=未实现 | 条款=工具异常统一映射错误码。 | 参考行=54 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
28. 状态=未实现 | 条款=文档内容视为非可信输入。 | 参考行=58 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
29. 状态=未实现 | 条款=禁止模型通过自然语言直接触发高风险副作用。 | 参考行=59 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
30. 状态=未实现 | 条款=高风险副作用必须走受控工具调用路径。 | 参考行=60 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
31. 状态=未实现 | 条款=工具调用前执行“权限 + 上下文 + 审批”三重校验。 | 参考行=61 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
32. 状态=未实现 | 条款=每个 MCP 服务声明最小权限。 | 参考行=69 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
33. 状态=未实现 | 条款=会话隔离，禁止跨租户上下文复用。 | 参考行=70 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
34. 状态=未实现 | 条款=工具响应必须可审计。 | 参考行=71 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
35. 状态=未实现 | 条款=明确任务状态与责任边界。 | 参考行=77 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
36. 状态=未实现 | 条款=异步交付必须有回执与超时策略。 | 参考行=78 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
37. 状态=未实现 | 条款=不可信外部 Agent 输出需二次校验。 | 参考行=79 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
38. 状态=未实现 | 条款=`trace_id` | 参考行=85 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
39. 状态=未实现 | 条款=`tenant_id` | 参考行=86 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
40. 状态=未实现 | 条款=`agent_id` | 参考行=87 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
41. 状态=未实现 | 条款=`tool_name` | 参考行=88 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
42. 状态=未实现 | 条款=`risk_level` | 参考行=89 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
43. 状态=未实现 | 条款=`input_hash` | 参考行=90 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
44. 状态=未实现 | 条款=`result_summary` | 参考行=91 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
45. 状态=未实现 | 条款=`status` | 参考行=92 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
46. 状态=未实现 | 条款=`latency_ms` | 参考行=93 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
47. 状态=未实现 | 条款=工具 schema 变更需契约回归。 | 参考行=97 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
48. 状态=未实现 | 条款=高风险工具变更需安全评审。 | 参考行=98 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
49. 状态=未实现 | 条款=互操作变更需灰度验证。 | 参考行=99 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
50. 状态=未实现 | 条款=所有变更必须有回滚策略。 | 参考行=100 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
51. 状态=未实现 | 条款=工具注册表与风险分级表。 | 参考行=104 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
52. 状态=未实现 | 条款=高风险动作审批拦截器。 | 参考行=105 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
53. 状态=未实现 | 条款=工具调用审计中间件。 | 参考行=106 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
54. 状态=未实现 | 条款=MCP 接入安全基线。 | 参考行=107 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
55. 状态=未实现 | 条款=A2A 外部结果校验器。 | 参考行=108 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
56. 状态=未实现 | 条款=所有生产工具均有完整契约。 | 参考行=112 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
57. 状态=未实现 | 条款=高风险动作无审批不可执行。 | 参考行=113 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
58. 状态=未实现 | 条款=工具调用链路可完整追溯。 | 参考行=114 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
59. 状态=未实现 | 条款=Model Context Protocol: https://modelcontextprotocol.io/ | 参考行=118 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
60. 状态=未实现 | 条款=Google A2A protocol: https://google.github.io/A2A/ | 参考行=119 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
61. 状态=未实现 | 条款=LangChain/LangGraph docs: https://docs.langchain.com/ | 参考行=120 | 说明: 未见工具注册表/审批拦截器/MCP/A2A 接入实现
